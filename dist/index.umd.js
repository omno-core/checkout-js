(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.CashierSDK = {}));
    ...
    class CashierSDK {
        constructor(config) {
            ...
            this.config = {
                ...
                device: exports.DeviceType.AUTO,
                ...config
            };
        ...
        detectDevice() {
            if (this.config.device && this.config.device !== exports.DeviceType.AUTO) {
            ...
            return isMobile ? exports.DeviceType.MOBILE : exports.DeviceType.DESKTOP;
        }
        destroy() {
        ...
        openPaymentIframe(paymentUrl, containerId) {
            ...
            if (this.device === exports.DeviceType.MOBILE) {
        ...
        createModal() {
            ...
            if (this.device === exports.DeviceType.DESKTOP) {
